...
### Screenshots
![](./assets/screenshot_2023_08_28_v1.0.0.png)

### Download
Pre-built binaries for **Windows**, **Linux**, and **MacOS** are available at ![Release](./release) page.
...
Please refer to ![License page](./blob/main/LICENSE) for details.
